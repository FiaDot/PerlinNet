...
void protobuf_AssignDesc_echo_2eproto() {
  ...
  static const int Echo_offsets_[2] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Echo, id_),
  };
  Echo_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Echo, _is_default_instance_));
}
...
void protobuf_AddDesc_echo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\necho.proto\022\010tutorial\"\037\n\004Echo\022\013\n\003msg\030\001 "
    "\001(\t\022\n\n\002id\030\002 \001(\005b\006proto3", 63);
...
const int Echo::kIdFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

Echo::Echo()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:tutorial.Echo)
}
...
Echo::Echo(const Echo& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:tutorial.Echo)
}
...
Echo::~Echo() {
  // @@protoc_insertion_point(destructor:tutorial.Echo)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:tutorial.Echo)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:tutorial.Echo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:tutorial.Echo)
  return false;
#undef DO_
}
...
void Echo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:tutorial.Echo)
  // optional string msg = 1;
  if (this->msg().size() > 0) {
  ...
  // @@protoc_insertion_point(serialize_end:tutorial.Echo)
}

::google::protobuf::uint8* Echo::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:tutorial.Echo)
  // optional string msg = 1;
  if (this->msg().size() > 0) {
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      this->msg().data(), this->msg().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tutorial.Echo)
  return target;
}
...
void Echo::clear_id() {
 ...
 ::google::protobuf::int32 Echo::id() const {
  // @@protoc_insertion_point(field_get:tutorial.Echo.id)
  return id_;
}
 void Echo::set_id(::google::protobuf::int32 value) {
